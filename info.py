...
BOT_TOKEN = environ.get('BOT_TOKEN', '5852623516:AAFDhXQo_zXXExhB1zSNm244RSWOsP_Nrpo')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '800422840 351170421').split()]
...
MSG_ALRT = environ.get('MSG_ALRT', 'THANK YOU Dr.Sathan Sir ☺️ ?')
